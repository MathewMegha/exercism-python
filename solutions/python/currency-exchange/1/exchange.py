...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    sneaky_rate = exchange_rate * (1 + spread/100)   # Step 1: shop adds fee to rate
    coins = budget / sneaky_rate                     # Step 2: trade money
    return int(coins // denomination) * denomination # Step 3: whole bills only
